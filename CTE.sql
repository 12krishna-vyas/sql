/*
A Common Table Expression (CTE) in SQL is a temporary, named result set 
defined within the execution scope of a single SELECT, INSERT, UPDATE, or DELETE statement
It can only store datya on temp bacis 
they help break down complex query into smaller logical parts
...
-- where amount is second height amount
with cte as 
...
-- correlated 
select emp_id emo_name,department,salary from employee as e
...
select  emp_id emo_name,department,salary,dept,deptsalary
